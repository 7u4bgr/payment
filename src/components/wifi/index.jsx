        ...
        <div>
          ...
          <>
            {information ? (
              <>
                {active === "wifi" ? (
                  <div className="grid grid-cols-2 w-auto pt-12 gap-12 pb-5 md:grid-cols-4">
                    {baktelecom.map((item) => (
                      <div className="flex flex-col items-center justify-center bg-lime-300 rounded-xl p-5 gap-4">
