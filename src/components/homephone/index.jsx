    ...
    <div>
      <div className="control flex flex-column justify-center h-2">
        <div>
          ...
          <>
            {information ? (<>
            {active==="homephone"? <div className="grid grid-cols-2 w-auto pt-12 gap-20 pb-5 md:grid-cols-4">
                {baktelecom.map((item) => (
                  
                    <div className="flex flex-col items-center justify-center bg-orange-300 rounded-xl p-5 gap-4 border-double border-4 border-violet-500 p-5 ">
